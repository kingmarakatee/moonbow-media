...
const STRINGS = {
  en: {
    ...
    workTitle: 'PORTFOLIO.',
    workSub: 'Selected projects.',
    workBoxes: ['GLOBAL CAMPAIGNS', 'CORPORATE DOCUMENTARIES', 'PREMIUM BROADCASTS'],
    workFooter: 'Our Work',
  ...
  pt: {
    ...
    workTitle: 'PORTFOLIO.',
    workSub: 'Projetos selecionados.',
    workBoxes: ['CAMPANHAS GLOBAIS', 'DOCUMENTÁRIOS CORPORATIVOS', 'TRANSMISSÕES PREMIUM'],
    workFooter: 'O Nosso Trabalho',
...
async function buildPDF(lang) {
  ...
  // 2: Challenge
  {
    ...
    drawFooter(page, t.challengeFooter, true);
  }
  ...
  // 3: About
  {
    ...
    drawFooter(page, t.aboutFooter, false);
  }
  ...
  // 4: Approach
  {
    ...
    drawFooter(page, t.approachFooter, false);
  }
  ...
  // 5: Values
  {
    ...
    drawFooter(page, t.valuesFooter, false);
  }
  ...
  // 6: Manifesto
  {
    ...
    drawFooter(page, t.manifestoFooter, true);
  }
  ...
  // 7: Services
  {
    ...
    drawFooter(page, t.servicesFooter, false);
  }
  ...
  // 8: Portfolio / Selected Work
  {
    ...
    drawFooter(page, t.workFooter, true);
  }
  ...
  // 9: Process
  {
    ...
    drawFooter(page, t.processFooter, false);
  }
  ...
  // 10: Numbers
  {
    ...
    drawFooter(page, t.metricsFooter, true);
  }
  ...
  // 11: Testimonials
  {
    ...
    drawFooter(page, t.testimonialsFooter, false);
  }
